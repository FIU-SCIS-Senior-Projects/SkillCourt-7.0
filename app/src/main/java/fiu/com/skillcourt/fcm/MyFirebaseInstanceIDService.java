...
public class MyFirebaseInstanceIDService extends FirebaseInstanceIdService {
     ...
     */
    private void sendRegistrationToDB(String token) {
        ...
        mFcmIdRef = mUserDatabaseReference.child("fcmId");
        mFcmIdRef.setValue(token);
