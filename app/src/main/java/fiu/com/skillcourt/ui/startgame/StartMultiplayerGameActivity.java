...
public class StartMultiplayerGameActivity extends BaseActivity {
...
//            }
            replaceFragment(StartMultiplayerGameFragment.newInstance(sequences == null ? new ArrayList<String>() : new ArrayList<String>(sequences)), false);
        }
